    ...
    <div class="bg-white shadow-md rounded-2xl p-8 w-full max-w-xl">
        ...
        <form action="{{ route('courses.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                <select id="category" name="category" required class="w-full px-3 py-2 border rounded-lg border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500">
