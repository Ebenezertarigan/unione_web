...
<body class="bg-white">
    ...
    <header>
        <nav class="fixed top-0 w-full z-50 flex items-center justify-between p-2 bg-black">
            ...
            <!-- Search Bar -->
            <div class="flex items-center space-x-2 flex-grow ml-4 max-w-full">
                <input type="search"
                    class="p-1 w-full border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                    placeholder="Search..." />
                <button class="p-1.5 text-white bg-ghost rounded-full hover:bg-ghost transition duration-200 text-xs">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div class="max-w-xs rounded overflow-hidden shadow-md bg-white">
                <img class="w-full h-32 object-cover"
                    src="{{ asset('img/' . ($course['thumbnail'] ?? 'default.jpg')) }}"
                    alt="Thumbnail">
                <div class="px-4 py-2">
                    <h2 class="font-bold text-lg mb-2">{{ $course['title'] }}</h2>
                    <div class="flex items-center space-x-2">
                        <img class="w-8 h-8 rounded-full object-cover"
                            src="images/header-kursus2.jpg" alt="User Avatar">
                        <h3 class="font-bold text-sm">Eben Tarigan</h3>
                    </div>
